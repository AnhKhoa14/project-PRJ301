...
public final class Cart_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("                                                        <div class=\"p-2 px-3 text-uppercase\">No</div>\n");
      out.write("                                                    </th>\n");
      out.write("                                                    <th scope=\"col\" class=\"border-0 bg-light\">\n");
      ...
      out.write("                                            <strong class=\"text-muted\">Tổng tiền hàng</strong>\n");
      out.write("                                            <strong>");
      ...
      out.write("                                        </li>\n");
      out.write("                                        <li class=\"d-flex justify-content-between py-3 border-bottom\">\n");
      out.write("                                            <strong class=\"text-muted\">Phí vận chuyển</strong>\n");
      out.write("                                            <strong>Free ship</strong>\n");
      out.write("                                        </li>\n");
      out.write("                                        <li class=\"d-flex justify-content-between py-3 border-bottom\">\n");
      out.write("                                            <strong class=\"text-muted\">VAT</strong>\n");
      out.write("                                            <strong>");
      ...
      out.write("                                        </li>\n");
      out.write("                                        <li class=\"d-flex justify-content-between py-3 border-bottom\">\n");
      out.write("                                            <strong class=\"text-muted\">Tổng thanh toán</strong>\n");
      ...
      out.write(" $</h5>\n");
      out.write("                                        </li>\n");
      out.write("                                    </ul><a href=\"OrderController\" class=\"btn btn-dark rounded-pill py-2 btn-block\">Mua hàng</a>\n");
      out.write("                                </div>\n");
      out.write("                            </div>\n");
      out.write("                        </div>\n");
      out.write("\n");
      ...
      out.write("    var quantityElement = document.getElementById(\"quantity\");\n");
      out.write("    var quantity = parseInt(quantityElement.textContent);\n");
      out.write("\n");
      out.write("    if (quantity > 0) {\n");
      out.write("        quantity--;\n");
      out.write("        quantityElement.textContent = quantity;\n");
      out.write("    }\n");
      out.write("}\n");
      out.write("\n");
    ...
    try {
      ...
      if (_jspx_eval_c_forEach_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        do {
          ...
          out.write("                                                        <button class=\"btnSub\" onclick=\"decreaseQuantity()\">-</button>\n");
          out.write("                                                        <strong id=\"quantity\">");
          out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${o.quantity + 1}", java.lang.String.class, (PageContext)_jspx_page_context, null));
          out.write("</strong>\n");
          out.write("                                                        <button class=\"btnAdd\" onclick=\"increaseQuantity()\">+</button>\n");
          out.write("                                                    </td>\n");
          out.write("                                                    <td class=\"align-middle\">\n");
          out.write("                                                        <a href=\"#\" class=\"text-dark\">\n");
          out.write("                                                            <button type=\"button\" name=\"action\" class=\"btn btn-danger\">Remove</button>\n");
          out.write("                                                        </a>\n");
          out.write("                                                    </td>\n");
          out.write("                                                </tr>\n");
          out.write("                                            ");
